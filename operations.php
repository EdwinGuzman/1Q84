<?php
$clientLibraryPath = '/home/bitbiker/public_html/ZendGdata/library';
...
// ***************************************************************** ****
        $table .= '<tr id="video_' . $videoId . '">'
                . '<td width="50"><img onclick="ytVideoApp.presentVideo(\''
                . $videoId. '\')" src="' . $thumbnailUrl. '" height="75" width="75"/></td>'
                . '<td><a onclick="ytVideoApp.presentVideo(\''
